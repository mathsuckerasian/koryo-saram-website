        ...
        <section className="about__content">
          ...
          <div className="about__text">
            <p>
              ...
              попытка собрать воедино историю, которую я долгое время не умела
              объяснить даже самой себе.
            </p>

            <p>
              В детстве мне было сложно отвечать на простые, на первый взгляд,
              вопросы: откуда я, кто я, почему, если я кореянка, я говорю на
              русском языке, почему моя культура кажется одновременно близкой и
              далёкой. Эти вопросы долго оставались без ясного ответа и
              превращались в ощущение внутренней разорванности.
            </p>
